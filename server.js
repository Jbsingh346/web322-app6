...
* 
*  Name: Jobanpreet Singh Student ID: 113188213 Date: 2022-12-01
*
*  Cyclic Web App URL: https://wild-jade-chinchilla-cape.cyclic.app/
*
*  GitHub Repository URL: https://github.com/Jbsingh346/web322-app6
...
app.use(clientSessions({
    ...
    secret: "Hi I don't know what to share, but I think this would work", // this should be a long un-guessable string.
...
app.get('/blog', async (req, res) => {
    ...
    // an object to store properties for the view
    let viewData = {};

    try{

        // empty array to hold "post" objects
        let posts = [];
